...
🙏 Acknowledgements
Ultralytics Team: For the open-source YOLO series models, especially the YOLO26 baseline.

Roboflow & M4SFWD: For providing the public forest wildfire datasets used in this research.

PyTorch Community: For the open-source deep learning framework and related tools.
...
GitHub Issues: https://github.com/Weaston-create/forest-wildfire-asca-yolo/issues
